...
UserRouter.post("/Upload-Profile", authentication(), validation(UploadProfilePicSchema), async (req, res) => {
...
UserRouter.post("/Upload-CoverPic", authentication(), CloudFileUpload({
    StorageApproach: StorageApproachEnum.Memory,
    allowFileFormat: allowFileFormats.img,
}).array("CoverPic", 5), async (req, res) => {
